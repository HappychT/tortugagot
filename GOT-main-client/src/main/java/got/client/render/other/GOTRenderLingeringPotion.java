...
public class GOTRenderLingeringPotion extends RenderSnowball {
    ...
    public void renderIcon(IIcon icon) {
        ...
        GOTRenderLingeringPotion.rotate(180.0F - this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
        GOTRenderLingeringPotion.rotate(-this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
