...
import got.common.entity.other.GOTEntityPotionExtra;
...
public class GOTItemSplashPotionExtra extends Item {

    private final List<PotionEffect> listEffects;
    private final double[] radius;

    public GOTItemSplashPotionExtra(double[] radius, PotionEffect... list) {
        setMaxStackSize(1);
        setHasSubtypes(true);
        setMaxDamage(0);
    ...
    public ItemStack onEaten(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        ...
        if (!world.isRemote) {
            List<PotionEffect> list = getEffects(itemstack);
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        if (isSplash(itemstack.getItemDamage())) {
            ...
            if (!world.isRemote) {
                world.spawnEntityInWorld(new GOTEntityPotionExtra(world, entityplayer, this.listEffects, this.radius));
            }
