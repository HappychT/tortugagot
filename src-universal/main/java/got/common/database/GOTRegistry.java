...
public class GOTRegistry {
    ...
    public static void assignContent() {
        ...
        thiefBoots = new GOTItemArmor(GOTMaterial.THIEF, 3, "3");
        thiefChestplate = new GOTItemArmor(GOTMaterial.THIEF, 1,"1");
        thiefHelmet = new GOTItemArmor(GOTMaterial.THIEF, 0, "0");
        thiefLeggings = new GOTItemArmor(GOTMaterial.THIEF, 2, "2");
