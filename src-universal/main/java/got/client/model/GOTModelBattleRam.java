...
public class GOTModelBattleRam extends ModelBase {
    ...
    public GOTModelBattleRam() {
        ...
        Structure.cubeList.add(new ModelBox(Structure, 59, 112, 22.0163F, 19.4232F, 35.5833F, 2, 2, 2, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 32, 112, -23.9837F, 19.4232F, -1.0167F, 2, 2, 2, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 20, 112, -23.9837F, 19.4232F, 35.5833F, 2, 2, 2, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 168, 256, 17.5163F, 17.9232F, -40.0167F, 4, 5, 80, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 41, -17.4837F, 18.4232F, -1.5167F, 35, 4, 3, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 27, -17.4837F, 18.3232F, -38.0167F, 35, 4, 3, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 34, -17.4837F, 18.4232F, 34.9833F, 35, 4, 3, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 18, -17.4837F, -9.5768F, 32.9833F, 35, 4, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 9, -17.4837F, -9.5768F, -38.0167F, 35, 4, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 0, -17.4837F, -9.5768F, -2.5167F, 35, 4, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 236, 0, 17.5163F, -10.0768F, -40.0167F, 4, 5, 80, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 172, 171, -21.4837F, -10.0768F, -40.0167F, 4, 5, 80, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 164, -1.9837F, -27.0768F, -41.0167F, 4, 7, 82, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 157, 35, -1.9837F, -20.0768F, -37.5167F, 4, 11, 4, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 157, 20, -1.9837F, -20.0768F, 33.4833F, 4, 11, 4, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 62, 147, -1.9837F, -20.0768F, -2.0167F, 4, 11, 4, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 0, 253, -21.4837F, 17.9232F, -40.0167F, 4, 5, 80, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 141, 110, -20.9837F, -5.0768F, 33.9833F, 3, 23, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 141, 82, 18.0163F, -5.0768F, 33.9833F, 3, 23, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 141, 0, 18.0163F, -5.0768F, -2.5167F, 3, 23, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 141, 28, -20.9837F, -5.0768F, -2.5167F, 3, 23, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 48, 112, 18.0163F, -5.0768F, -38.9167F, 3, 23, 5, 0.0F));
        Structure.cubeList.add(new ModelBox(Structure, 64, 119, -20.9837F, -5.0768F, -38.9167F, 3, 23, 5, 0.0F));

        Structure_r1 = new ModelRenderer(this);
        Structure_r1.setRotationPoint(-16.4837F, 47.3232F, -35.5167F);
        ...
        Structure_r2.setRotationPoint(-16.4837F, 6.4232F, -35.5167F);
        ...
        Structure_r3.setRotationPoint(2.0163F, -0.127F, -37.4522F);
        ...
        Structure_r4.setRotationPoint(1.5163F, 16.1364F, 9.9417F);
        ...
        Structure_r5.setRotationPoint(-0.4837F, -11.5768F, -18.0167F);
        ...
        Structure_r6.setRotationPoint(0.5163F, -11.5768F, -18.0167F);
        ...
        Ram.cubeList.add(new ModelBox(Ram, 157, 82, -4.0267F, -4.1233F, 5.4413F, 8, 8, 2, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 20, 149, -4.0267F, -4.1233F, -14.5587F, 8, 8, 2, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 155, 153, -4.0267F, -4.1233F, 22.4413F, 8, 8, 2, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 155, 71, -4.0267F, -4.1233F, 33.9413F, 8, 8, 2, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 64, 116, -5.8052F, -2.4674F, 22.9403F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 171, 124, -5.8052F, -2.4674F, 5.9403F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 164, 132, -5.9052F, -2.4674F, -14.0597F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 179, 26, -5.9052F, -2.4674F, -32.0597F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 179, 32, 4.9045F, -2.4674F, -32.0597F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 164, 50, 4.9045F, -2.4674F, -14.0597F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 30, 179, 4.9045F, -2.4674F, 5.9423F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 44, 153, 4.9045F, -2.4674F, 22.9423F, 1, 5, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 48, 140, -0.5267F, -3.1233F, 38.9413F, 1, 2, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 0, 0, -0.5267F, -2.1233F, 39.9413F, 1, 4, 1, 0.0F));
        Ram.cubeList.add(new ModelBox(Ram, 141, 0, -0.5267F, 0.8767F, 38.9413F, 1, 2, 1, 0.0F));

        Ram_r1 = new ModelRenderer(this);
        Ram_r1.setRotationPoint(4.4733F, 1.0767F, 23.4413F);
        Ram.addChild(Ram_r1);
        ...
        Ram_r2.setRotationPoint(4.4733F, 1.0767F, 23.4413F);
        Ram.addChild(Ram_r2);
        ...
        Ram_r3.setRotationPoint(-5.1364F, 1.1055F, -31.5587F);
        Ram.addChild(Ram_r3);
        ...
        Ram_r4.setRotationPoint(-5.4204F, -2.2593F, -31.5587F);
        Ram.addChild(Ram_r4);
        ...
        RamHead.setRotationPoint(-0.0267F, -0.1233F, -46.5587F);
        ...
        Rope1.setRotationPoint(-11.6502F, 11.3787F, 34.0F);
        ...
        Rope4.setRotationPoint(0.4F, 34.0F, 35.0F);
        ...
        Rope2.setRotationPoint(-11.6502F, 11.3787F, -1.0F);
        ...
        Rope5.setRotationPoint(0.4F, 34.0F, 0.0F);
        ...
        Rope3.setRotationPoint(-6.6502F, 8.3787F, 35.0F);
        ...
        Rope6.setRotationPoint(0.4F, 34.0F, -35.0F);
        ...
        Wheel1.cubeList.add(new ModelBox(Wheel1, 30, 164, -1.0F, -6.5F, -4.5F, 2, 13, 2, 0.0F));
        Wheel1.cubeList.add(new ModelBox(Wheel1, 48, 140, -1.0F, -7.5F, -2.5F, 2, 15, 5, 0.0F));
        Wheel1.cubeList.add(new ModelBox(Wheel1, 38, 164, -1.0F, -6.5F, 2.5F, 2, 13, 2, 0.0F));
        Wheel1.cubeList.add(new ModelBox(Wheel1, 169, 139, -1.0F, -5.5F, 4.5F, 2, 11, 1, 0.0F));
        Wheel1.cubeList.add(new ModelBox(Wheel1, 173, 36, -1.0F, -4.5F, 5.5F, 2, 9, 1, 0.0F));
        ...
        Wheel2.cubeList.add(new ModelBox(Wheel2, 46, 164, -1.0F, -6.5F, -4.5F, 2, 13, 2, 0.0F));
        Wheel2.cubeList.add(new ModelBox(Wheel2, 141, 56, -1.0F, -7.5F, -2.5F, 2, 15, 5, 0.0F));
        Wheel2.cubeList.add(new ModelBox(Wheel2, 54, 164, -1.0F, -6.5F, 2.5F, 2, 13, 2, 0.0F));
        Wheel2.cubeList.add(new ModelBox(Wheel2, 171, 12, -1.0F, -5.5F, 4.5F, 2, 11, 1, 0.0F));
        Wheel2.cubeList.add(new ModelBox(Wheel2, 175, 119, -1.0F, -4.5F, 5.5F, 2, 9, 1, 0.0F));
        ...
        Wheel3.cubeList.add(new ModelBox(Wheel3, 62, 164, -1.0F, -6.5F, 2.5F, 2, 13, 2, 0.0F));
        Wheel3.cubeList.add(new ModelBox(Wheel3, 141, 138, -1.0F, -7.5F, -2.5F, 2, 15, 5, 0.0F));
        Wheel3.cubeList.add(new ModelBox(Wheel3, 70, 164, -1.0F, -6.5F, -4.5F, 2, 13, 2, 0.0F));
        Wheel3.cubeList.add(new ModelBox(Wheel3, 142, 171, -1.0F, -5.5F, -5.5F, 2, 11, 1, 0.0F));
        Wheel3.cubeList.add(new ModelBox(Wheel3, 175, 149, -1.0F, -4.5F, -6.5F, 2, 9, 1, 0.0F));
        ...
        Wheel4.cubeList.add(new ModelBox(Wheel4, 155, 51, -1.0F, -7.5F, -2.5F, 2, 15, 5, 0.0F));
        Wheel4.cubeList.add(new ModelBox(Wheel4, 90, 164, -1.0F, -6.5F, -4.5F, 2, 13, 2, 0.0F));
        Wheel4.cubeList.add(new ModelBox(Wheel4, 148, 171, -1.0F, -5.5F, -5.5F, 2, 11, 1, 0.0F));
        Wheel4.cubeList.add(new ModelBox(Wheel4, 130, 176, -1.0F, -4.5F, -6.5F, 2, 9, 1, 0.0F));
        Wheel4.cubeList.add(new ModelBox(Wheel4, 0, 179, -1.0F, -2.5F, -7.5F, 2, 5, 1, 0.0F));
        ...
        Wheel5.cubeList.add(new ModelBox(Wheel5, 122, 164, -1.0F, -6.5F, 2.5F, 2, 13, 2, 0.0F));
        Wheel5.cubeList.add(new ModelBox(Wheel5, 157, 0, -1.0F, -7.5F, -2.5F, 2, 15, 5, 0.0F));
        Wheel5.cubeList.add(new ModelBox(Wheel5, 169, 50, -1.0F, -6.5F, -4.5F, 2, 13, 2, 0.0F));
        Wheel5.cubeList.add(new ModelBox(Wheel5, 172, 171, -1.0F, -5.5F, -5.5F, 2, 11, 1, 0.0F));
        Wheel5.cubeList.add(new ModelBox(Wheel5, 177, 92, -1.0F, -4.5F, -6.5F, 2, 9, 1, 0.0F));
        ...
        Wheel6.cubeList.add(new ModelBox(Wheel6, 114, 164, -1.0F, -6.5F, 2.5F, 2, 13, 2, 0.0F));
        Wheel6.cubeList.add(new ModelBox(Wheel6, 155, 133, -1.0F, -7.5F, -2.5F, 2, 15, 5, 0.0F));
        Wheel6.cubeList.add(new ModelBox(Wheel6, 106, 164, -1.0F, -6.5F, -4.5F, 2, 13, 2, 0.0F));
        Wheel6.cubeList.add(new ModelBox(Wheel6, 160, 171, -1.0F, -5.5F, -5.5F, 2, 11, 1, 0.0F));
        Wheel6.cubeList.add(new ModelBox(Wheel6, 177, 10, -1.0F, -4.5F, -6.5F, 2, 9, 1, 0.0F));
        Wheel6.cubeList.add(new ModelBox(Wheel6, 12, 179, -1.0F, -2.5F, -7.5F, 2, 5, 1, 0.0F));
    }
