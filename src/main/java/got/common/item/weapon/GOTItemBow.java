...
public class GOTItemBow extends ItemBow {
    ...
    public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityPlayer entityplayer, int i) {
        ...
        if (arrowItem != null) {
            ...
            float chargeFinal = charge * 2.0f * GOTItemBow.getLaunchSpeedFactor(itemstack);
            EntityArrow arrow = new EntityArrow(world, entityplayer, chargeFinal);
            if(arrowItem.getItem() == GOTRegistry.arrowFire) {
                arrow = new GOTEntityArrowFire(world, entityplayer, chargeFinal);
            } else if(arrowItem.getItem() == GOTRegistry.arrowPoisoned) {
                arrow = new GOTEntityArrowPoisoned(world, entityplayer, chargeFinal);
            }

            if(this == GOTRegistry.firstPeopleBow) {
                arrow = new GOTEntityArrowSerrated(world, entityplayer, chargeFinal);
            }
    ...
    public void registerIcons(IIconRegister iconregister) {
        ...
        if (bowRenderer instanceof GOTRenderBow && ((GOTRenderBow) bowRenderer).isLargeBow()) {
            ...
            this.bowPullIcons[0] = iconregister.registerIcon(getIconString() + "_" + BowState.PULL_0.iconName);
            this.bowPullIcons[1] = iconregister.registerIcon(getIconString() + "_" + BowState.PULL_1.iconName);
            this.bowPullIcons[2] = iconregister.registerIcon(getIconString() + "_" + BowState.PULL_2.iconName);
        }
    }
