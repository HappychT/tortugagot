...
//        reach.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.reachguardBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
    ...
    public static void createStandardRecipes() {
        ...
        GameRegistry.addRecipe(new GOTRecipePolearmWeapon());
    ...
    public static void createUnsmeltingRecipes() {
        ...
        unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.baratheonHammer), "XYX", "XYX", " Y ", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
        ...
        unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.lightbringersec), "X", "X", "Y", Character.valueOf('X'), GOTRegistry.valyrianIngot, Character.valueOf('Y'), "stickWood"));
...
//        westerlands.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westerlandsguardBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
    ...
    public static void registerOres() {
        ...
        OreDictionary.registerOre("meat", GOTRegistry.camelRaw);
        OreDictionary.registerOre("meat", GOTRegistry.deerRaw);
        OreDictionary.registerOre("meat", GOTRegistry.elephantRaw);
        OreDictionary.registerOre("meat", GOTRegistry.lionRaw);
        OreDictionary.registerOre("meat", GOTRegistry.muttonRaw);
        OreDictionary.registerOre("meat", GOTRegistry.rabbitRaw);
        OreDictionary.registerOre("meat", GOTRegistry.rhinoRaw);
        OreDictionary.registerOre("meat", GOTRegistry.walrusLardRaw);
        OreDictionary.registerOre("meat", GOTRegistry.zebraRaw);
        OreDictionary.registerOre("meat", Items.beef);
        OreDictionary.registerOre("meat", Items.chicken);
        OreDictionary.registerOre("meat", Items.porkchop);
    }
