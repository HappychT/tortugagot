...
public class GOTPlayerData {
    ...
    public GOTFellowship getChatBoundFellowship() {
        if (this.chatBoundFellowshipID != null) {
            GOTFellowship fs = GOTFellowshipData.getActiveFellowship(this.chatBoundFellowshipID);
            if (fs != null)
                return fs;
        }
        return null;
    ...
    public int getWPUseCount(GOTAbstractWaypoint wp) {
        if (wp instanceof GOTCustomWaypoint) {
            ...
            } else if (this.cwpUseCounts.containsKey(Integer.valueOf(ID)))
                return this.cwpUseCounts.get(Integer.valueOf(ID));
    ...
    public boolean isPledgeEnemyAlignmentLimited(GOTFaction fac) {
        return this.pledgeFaction != null && doesFactionPreventPledge(this.pledgeFaction, fac);
    }
    ...
    public void load(NBTTagCompound playerData) {
        ...
        if (playerData.hasKey("bridleMountUUID")) {
            this.bridleMount = playerData.getInteger("bridleMountUUID");
        }
    ...
    public void save(NBTTagCompound playerData) {
        ...
        if (this.bridleMount != -1) {
            playerData.setInteger("bridleMountUUID", this.bridleMount);
        }
    ...
    public int getBridleMount() {
        return this.bridleMount;
    }

    public void setBridleMount(int bridleMount) {
        this.bridleMount = bridleMount;
        markDirty();
    }
    ...
    public void updateFastTravelClockFromLastOnlineTime(ICommandSender player, World world) {
        ...
        if (!server.isSinglePlayer()) {
            ...
            if (ftClockIncrease > 0) {
                setTimeSinceFTWithUpdate(this.ftSinceTick + ftClockIncrease);
