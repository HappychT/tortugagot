...
public class PoliticsPage implements IPageRenderer {
    ...
    public void initGui(List<GuiButton> buttonList) {
        ...
        buttonWarCouncil = new GuiCustomButton(50, xSize - 175, 15, 150, 20, "Военный совет");
    ...
    public void drawScreen(int mouseX, int mouseY, int scaledMouseX, int scaledMouseY, float partialTicks) {
        ...
        parent.drawCenteredString("Политика - " + GOTGuiFactions.currentFaction.factionName(), parent.getBaseWidth() / 2, 15, 0xFFFFFF);
        ...
        final int x = 25;
        final int y = 40;
        final int columnWidth = (parent.getBaseWidth() - 70) / 3;
