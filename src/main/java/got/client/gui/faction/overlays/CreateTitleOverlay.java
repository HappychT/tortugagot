...
public class CreateTitleOverlay implements IOverlayRenderer {
    ...
    public void initGui(List<GuiButton> buttonList) {
        ...
        buttonCreateTitle = new GuiButton(17, overlayX - 102, overlayY + 80, 100, 20, "Создать");
        buttonCancelTitle = new GuiButton(18, overlayX + 2, overlayY + 80, 100, 20, "Отмена");
    ...
    private void drawCheckbox(int x, int y, String label, boolean isChecked) {
        ...
        if (isChecked) {
            parent.drawCenteredString("✓", x + boxSize / 2, y + 1, 0xFF00DD00);
        }
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (button == 0) {
            ...
            int checkX = overlayX - 100;
            for (Faction.Permission perm : Faction.Permission.values()) {
                if (parent.isHover(checkX, checkY, 150, 15)) {
