...
public class brienne_body extends ModelBiped {
	...
	public brienne_body() {
		...
		Left_Leg_Layer_r1.cubeList.add(new ModelBox(Left_Leg_Layer_r1, 44, 1, -1.6F, -12.0F, -2.5F, 5, 9, 5, 0.22F));
		...
		Right_Leg_Layer_r1.cubeList.add(new ModelBox(Right_Leg_Layer_r1, 44, 1, -3.4F, -12.0F, -2.5F, 5, 9, 5, 0.22F));
