...
public class arryn_body extends ModelBiped {
	...
	public arryn_body() {
		...
		Left_Leg_Layer_r1.cubeList.add(new ModelBox(Left_Leg_Layer_r1, 44, 2, -1.6F, -12.0F, -2.5F, 5, 9, 5, 0.11F));
		...
		Right_Leg_Layer_r1.cubeList.add(new ModelBox(Right_Leg_Layer_r1, 44, 2, -3.4F, -12.0F, -2.5F, 5, 9, 5, 0.11F));
		...
		right_arm_head_extension_r1.cubeList.add(new ModelBox(right_arm_head_extension_r1, 42, 20, -10.5F, -15.5F, -1.5F, 6, 7, 5, 0.31F));
		...
		left_arm_head_extension_r1.cubeList.add(new ModelBox(left_arm_head_extension_r1, 42, 20, 3.5F, -15.5F, 0.5F, 6, 7, 5, 0.31F));
