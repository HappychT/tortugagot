...
public class westerlands_helmet extends ModelBiped {
	public westerlands_helmet() {
		super(0.0F);
		textureWidth = 64;
		textureHeight = 64;
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 38, 52, -6.5F, -13.75F, 0.0F, 13, 12, 0, 0.0F));
