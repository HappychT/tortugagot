...
public class hound_body extends ModelBiped {
	...
	public hound_body() {
		...
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 0, 32, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.6F));
		...
		Left_Leg_Layer_r1.cubeList.add(new ModelBox(Left_Leg_Layer_r1, 44, 16, -1.6F, -12.0F, -2.5F, 5, 9, 5, 0.19F));
