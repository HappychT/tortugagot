...
public class kingslanding_body extends ModelBiped {
	...
	public kingslanding_body() {
		...
		armorCape9.cubeList.add(new ModelBox(armorCape9, 19, 37, -6.0F, 1.5F, -0.65F, 12, 12, 1, 0.0F));
		...
		capeMid9.cubeList.add(new ModelBox(capeMid9, 19, 51, -27.5F, -0.1305F, -0.9914F, 12, 6, 1, -0.01F));
		...
		capeLow.cubeList.add(new ModelBox(capeLow, 19, 59, -6.5F, -0.1271F, 0.0311F, 12, 4, 1, 0.0F));
