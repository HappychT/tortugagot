...
public class stormlands_helmet extends ModelBiped {
	public stormlands_helmet() {
		super(0.0F);
		textureWidth = 64;
		textureHeight = 64;
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 18, 51, -5.0F, -5.0F, -6.0F, 10, 1, 12, 0.0F));
