...
public class king_robberts_body extends ModelBiped {
	private final ModelRenderer save_with_body2;
	...
	public king_robberts_body() {
		...
		save_with_body2 = new ModelRenderer(this);
		save_with_body2.setRotationPoint(0.1F, 12.0F, 0.0F);
		bipedLeftLeg.addChild(save_with_body2);

		Left_Leg_Layer_r1 = new ModelRenderer(this);
		Left_Leg_Layer_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
		save_with_body2.addChild(Left_Leg_Layer_r1);
		setRotationAngle(Left_Leg_Layer_r1, 0.0F, 0.0F, -0.0873F);
		Left_Leg_Layer_r1.cubeList.add(new ModelBox(Left_Leg_Layer_r1, 44, 2, -1.6F, -12.0F, -2.5F, 5, 9, 5, 0.175F));
		...
		Right_Leg_Layer_r1.cubeList.add(new ModelBox(Right_Leg_Layer_r1, 44, 18, -3.4F, -12.0F, -2.5F, 5, 9, 5, 0.175F));
		...
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 24, 16, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.85F));
		...
		bipedLeftArm.mirror = true;
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 24, 16, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.85F));
		bipedLeftArm.mirror = false;
		...
		bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 16, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.7F));
		bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 32, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.9F));
		bipedBody.cubeList.add(new ModelBox(bipedBody, 0, 0, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.5F));
