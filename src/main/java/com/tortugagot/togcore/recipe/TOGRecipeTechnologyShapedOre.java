...
public class TOGRecipeTechnologyShapedOre implements IRecipe {
    private final ShapedOreRecipe recipe;
    private final String[] requiredTechnologyIds;

    public TOGRecipeTechnologyShapedOre(ItemStack result, Object[] recipeParams, String... requiredTechnologyIds) {
        recipe = new ShapedOreRecipe(result, recipeParams);
        this.requiredTechnologyIds = requiredTechnologyIds;
    }

    public static TOGRecipeTechnologyShapedOre shaped(ItemStack result, Object[] recipeParams, String... requiredTechnologyIds) {
        return new TOGRecipeTechnologyShapedOre(result, recipeParams, requiredTechnologyIds);
    }
