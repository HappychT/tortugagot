...
public class GOTDispenseThrowingKnife extends BehaviorDefaultDispenseItem {
    @Override
    public ItemStack dispenseStack(IBlockSource dispense, ItemStack itemstack) {
        ...
        GOTEntityThrowingKnife knife = new GOTEntityThrowingKnife(world, itemstack.copy(), iposition.getX(), iposition.getY(), iposition.getZ());
        knife.setThrowableHeading(enumfacing.getFrontOffsetX(), enumfacing.getFrontOffsetY() + 0.1f, enumfacing.getFrontOffsetZ(), 1.1f, 6.0f);
        knife.canBePickedUp = 1;
        knife.effectType = itemstack.getItem() == GOTRegistry.thiefThrowingKnifePoison ? 0 : 1;
