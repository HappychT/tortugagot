...
public class GOTMaterial {
	...
	public static ArmorMaterial BLACKSKIN = EnumHelper.addArmorMaterial("GOT_BLACKSKIN", 60, new int[] { 2, 7, 6, 3 }, 9);
	public static ArmorMaterial BONE = EnumHelper.addArmorMaterial("GOT_BONE", 12, new int[] { 1, 3, 2, 1 }, 15);
	...
	public static ArmorMaterial GIFT = EnumHelper.addArmorMaterial("GOT_GIFT", 37, new int[] { 2, 6, 5, 2 }, 9);
	public static ArmorMaterial GOLDENCOMPANY = EnumHelper.addArmorMaterial("GOT_GOLDENCOMPANY", 37, new int[] { 2, 6, 5, 2 }, 9);
	public static ArmorMaterial HAND = EnumHelper.addArmorMaterial("GOT_HAND", 12, new int[] { 1, 3, 2, 1 }, 15);
	public static ArmorMaterial HELMET = EnumHelper.addArmorMaterial("GOT_HELMET", 60, new int[] { 2, 7, 6, 3 }, 9);
	...
	public static ArmorMaterial LHAZAR = EnumHelper.addArmorMaterial("GOT_LHAZAR", 12, new int[] { 1, 3, 2, 1 }, 15);
	public static ArmorMaterial LHAZAR_LION = EnumHelper.addArmorMaterial("GOT_LHAZAR_LION", 12, new int[] { 1, 3, 2, 1 }, 15);
	public static ArmorMaterial LORATH = EnumHelper.addArmorMaterial("GOT_LORATH", 37, new int[] { 2, 6, 5, 2 }, 9);
	...
	public static ArmorMaterial UNSULLIED = EnumHelper.addArmorMaterial("GOT_UNSULLIED", 60, new int[] { 2, 7, 6, 3 }, 9);
