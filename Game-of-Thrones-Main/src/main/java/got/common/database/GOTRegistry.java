...
import got.common.item.weapon.GOTItemCrossbowFirstPeople;
import got.common.item.weapon.GOTItemDagger;
import got.common.item.weapon.GOTItemDamnedCaptainSaber;
...
import got.common.item.weapon.GOTItemGiantClub;
...
import got.common.item.weapon.GOTItemLeaderBattleaxe;
...
import got.common.item.weapon.GOTItemThiefKnife;
...
public class GOTRegistry {
    ...
    public static void assignContent() {
        ...
        bericSword = new GOTItemLegendarySword(GOTMaterial.IRON, GOTItemSword.HitEffect.FIRE);
        ...
        dye = new GOTItemDye();
        eddardSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        gregorCleganeSword = new GOTItemLegendaryGreatsword(GOTMaterial.IRON);
        ...
        hearteater = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        ibbenSword = new GOTItemSword(GOTMaterial.IRON);
        ...
        jaimeSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        needle = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        nomadSword = new GOTItemSword(GOTMaterial.IRON);
        ...
        robbSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        rollingPin = new GOTItemSword(GOTMaterial.WOOD);
        ...
        sandorCleganeSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        summerSword = new GOTItemSword(GOTMaterial.IRON);
        ...
        tormundSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        trident = new GOTItemTrident(GOTMaterial.IRON);
        truth = new GOTItemLegendarySword(GOTMaterial.VALYRIAN_TOOL);
        trystaneSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        tugarKhanSword = new GOTItemLegendarySword(GOTMaterial.IRON);
        ...
        walkingStick = new GOTItemSword(GOTMaterial.WOOD);
        ...
        westerosLance = new GOTItemLance(GOTMaterial.IRON);
        ...
        thiefBoots = new GOTItemArmor(GOTMaterial.THIEF, 3);
        thiefChestplate = new GOTItemArmor(GOTMaterial.THIEF, 1);
        thiefHelmet = new GOTItemArmor(GOTMaterial.THIEF, 0);
        thiefLeggings = new GOTItemArmor(GOTMaterial.THIEF, 2);
        ...
        chiefNecklace = new GOTItemJewelryActive(20).addPotionEffect(Potion.damageBoost, 29 * 60 + 59);
        direwolfFang = new GOTItemJewelryActive(45).addPotionEffect(Potion.damageBoost, 8 * 60);
        ritualBlade = new GOTItemJewelryActive(45).addPotionEffect(Potion.regeneration, 3 * 60).addPotionEffect(GOTEffects.rage, 5 * 60);
        ...
        chainMaester = new GOTItemJewelryActive(45).addPotionEffect(Potion.regeneration, 10 * 60).addPotionEffect(Potion.field_76434_w, 120);
        ...
        firstPeopleHelmet = new GOTItemArmor(GOTMaterial.FIRST_PEOPLE, 0);
        ...
        amuletCatEye = new GOTItemJewelryActive(100).addPotionEffect(GOTEffects.catEye, 3 * 60);
        firstPeopleBow = new GOTItemBow(GOTMaterial.FIRST_PEOPLE_WEAPON, 1.3).setDrawTime(25).setMaxDamage(7000);
