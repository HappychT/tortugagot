...
public class GOTEntityLingeringBombEffect extends Entity implements IEntityAdditionalSpawnData {
    ...
    public GOTEntityLingeringBombEffect(World world) {
        super(world);
        this.yOffset = 0;
        setSize(1, 1);
    }

    public GOTEntityLingeringBombEffect(World world, GOTEntityLingeringPotion potion) {
        this(world, potion.getStack(), potion.getThrower());
        setPosition(potion.posX, potion.posY, potion.posZ);
    }

    public GOTEntityLingeringBombEffect(World world, ItemStack stack, EntityLivingBase thrower) {
        this(world);
        this.stack = stack;
    ...
    public void applyEntityCollision(Entity e) {
        ...
        List<PotionEffect> effects = ((GOTItemToxinBomb)this.stack.getItem()).getEffects(this.stack);
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.ticksExisted % 5 == 0) {
                ...
                if(this.stack.getItem() instanceof GOTItemToxinBomb) {
                    colour =
                            Potion.potionTypes[((GOTItemToxinBomb)this.stack.getItem()).getEffects(this.stack).get(0).getPotionID()]
                                    .getLiquidColor();
                }
